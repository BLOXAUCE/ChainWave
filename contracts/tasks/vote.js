...
module.exports = async function (taskArgs, hre) {
    ...
    const adapterParams = ethers.utils.solidityPack(["uint16", "uint256"], [1, 2000000]) // default adapterParams example
    ...
    const tx = await (await votingSender.sendVote(1, 1, true, [], { value: fees[0] + 222 })).wait()
